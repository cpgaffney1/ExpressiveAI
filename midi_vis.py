...
MIDI_FILE = 'C://Users//cpgaffney1//Documents//NetBeansProjects//ProjectMusic//files//intermediate_predictions//02_liebstrm.mid'
WAV_FILE_ORIGINAL = 'C://Users//cpgaffney1//Documents//NetBeansProjects//ProjectMusic//files//intermediate_predictions//02_liebstrm.wav'
WAV_FILE_TEMP = 'C://Users//cpgaffney1//Documents//NetBeansProjects//ProjectMusic//files//tmp//animation_audio.wav' # temporary store for padded version of audio
LENGTH = 263 # length of the video file to be generated, in seconds

OUTPUT_FILE = 'C://Users//cpgaffney1//Documents//NetBeansProjects//ProjectMusic//files//intermediate_predictions//liebstrm.mp4'
...
class Note(object):
  ...
  def draw(self, t):
    ...
    if t<self.t0:
      ...
      outline_fade = 1
    outcol = NOTE_COLOURS[min((self.note * NUM_COLOURS) // (HIGHEST_NOTE - LOWEST_NOTE), NUM_COLOURS - 1)]
...
if MODE == 'play':
  ...
  titles = TextClip(
    ...
    "Performed by Intel i7\nLive recording, Stanford, CA\n" +
    "Date",
